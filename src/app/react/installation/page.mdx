...
If accessibility is one of your main concerns, I suggest you rather to use <Link href='/shadcn/installation'>shadcn</Link> components even tho these react components are somewhat accessible.
