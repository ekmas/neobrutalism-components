...
export default function ScrollAreaDemo() {
  return (
    <ScrollArea className="rounded-base h-[300px] text-foreground border-2 border-border bg-secondary-background p-4 shadow-shadow">
      ...
      he couldn&apos;t seem to stop Jokester. And then, one day, the people of
      the kingdom discovered that the jokes left by Jokester were so funny that
