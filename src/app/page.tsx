    ...
    <div className="text-foreground">
      <main className="relative flex min-h-[100svh] flex-col items-center justify-center bg-background px-5 py-[200px] font-bold">
        <div className="mx-auto w-container max-w-full grid grid-cols-2 m1100:grid-cols-1">
          <div className="text-left m1000:text-center m1100:w-4/5 m1000:w-full">
            ...
            <Link
              className="flex items-center w-max m1000:mx-auto text-main-foreground rounded-base border-2 font-base border-border bg-main px-10 py-3 text-[22px] shadow-shadow transition-all hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none m800:px-8 m800:py-2.5 m800:text-lg m500:px-6 m400:px-4 m400:text-sm m500:py-2 m500:text-base"
              href={"/docs"}
            >
              Read the docs
      ...
      <div>
        ...
        <div className="grid grid-cols-2 border-b-4 border-t-4 border-border m700:grid-cols-1">
          ...
          <section className="border-b-4 border-border text-main-foreground m700:dark:text-main-foreground bg-main p-14 py-16 m1300:p-10 m1300:py-12 m800:p-6 m800:py-8 m700:bg-background">
            <div className="flex items-center gap-6 mb-6">
              <div className="w-[70px] h-[70px] m1300:w-[55px] m1300:h-[55px] m800:h-10 m800:w-10 flex items-center justify-center">
                <OpenSourceIcon />
              </div>
          ...
          <section className="border-r-4 border-border bg-main dark:text-main-foreground p-14 py-16 m1300:p-10 m1300:py-12 m800:p-6 m800:py-8 m700:border-b-4 m700:border-r-0">
            <div className="flex items-center gap-6 mb-6">
              <div className="w-[70px] h-[70px] m1300:w-[55px] m1300:h-[55px] m800:h-10 m800:w-10 flex items-center justify-center">
                <ShadcnIcon />
              </div>
          ...
          <section className="bg-background p-14 py-16 m1300:p-10 m1300:py-12 m800:p-6 m800:py-8">
            <div className="flex items-center gap-6 mb-6">
              <div className="w-[70px] h-[70px] m1300:w-[55px] m1300:h-[55px] m800:h-10 m800:w-10 flex items-center justify-center">
                <CustomizableIcon />
              </div>
              ...
              {[
                ...
                <div className="group flex flex-col justify-center" key={index}>
                  {card.map(({ jobTitle, pfp, fullName, review }, index) => (
                    <div
                      className="m1000:min-h-20 m1000:w-2/3 m1000:mx-auto m500:w-full mb-4 min-h-48 w-full rounded-base border-2 border-border bg-background p-5 shadow-shadow lg:mb-8"
                      key={index}
                    >
        ...
        <section className="border-t-4 border-t-border border-b-4 border-b-border bg-background py-20 m500:py-14 font-base lg:py-[100px]">
