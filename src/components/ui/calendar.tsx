...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        className,
        '!rounded-base border-2 border-black bg-main p-3 font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]',
      )}
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-black rounded-base w-9 font-bold text-[0.8rem]',
