  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "bg-bg group/drawer-content fixed z-50 flex h-auto flex-col",
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block bg-blank" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
