...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-11 w-full rounded-md bg-transparent py-3 text-sm outline-hidden placeholder:text-text placeholder:opacity-50 disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
