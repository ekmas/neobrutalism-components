    ...
    <>
      <Tabs defaultValue="preview" className="w-full">
        ...
        <TabsContent value="preview">
          <div className="not-prose flex w-full items-center justify-center z-15 relative border-2 mb-5 min-h-[200px] border-border bg-secondary-background bg-[15px_20px] bg-[linear-gradient(to_right,#8080804D_1px,transparent_1px),linear-gradient(to_bottom,#80808090_1px,transparent_1px)] px-10 py-20 shadow-shadow [background-size:40px_40px]">
            <ExampleComponent />
          </div>
        </TabsContent>
