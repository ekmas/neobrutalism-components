  ...
  return ReactDom.createPortal(
    ...
    >
      <div
        ...
        className="relative flex w-[350px] flex-col items-center justify-center rounded-md border-2 border-black bg-main p-10 pt-12 font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-300"
      >
