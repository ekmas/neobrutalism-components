...
<Tabs defaultValue="css-vars" className="w-full">
  ...
  <TabsContent value="util">
    <Tabs defaultValue="pnpm" className="w-full">
      ...
      <TabsContent value="pnpm">
      ```
      pnpm dlx shadcn@latest add http://util.neobrutalism.dev/r/button.json
      ```
      </TabsContent>
      <TabsContent value="npm">
      ```
      npx shadcn@latest add http://util.neobrutalism.dev/r/button.json
      ```
      </TabsContent>
      <TabsContent value="yarn">
      ```
      ...
      <TabsContent value="bun">
      ```
      bunx --bun shadcn@latest add http://util.neobrutalism.dev/r/button.json
      ```
      </TabsContent>
    </Tabs>
  </TabsContent>
