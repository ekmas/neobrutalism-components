...
<ComponentPreview component="scroll-area">
  ```tsx file=<rootDir>/src/examples/ui/scroll-area/index.tsx
  ```
</ComponentPreview>
...
<ComponentPreview component="scroll-area" example="default">
  ```tsx file=<rootDir>/src/examples/ui/scroll-area/index.tsx
  ```
</ComponentPreview>
...
<ComponentPreview component="scroll-area" example="horizontal">
  ```tsx file=<rootDir>/src/examples/ui/scroll-area/horizontal.tsx
  ```
</ComponentPreview>
