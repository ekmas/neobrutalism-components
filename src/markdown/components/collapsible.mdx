...
<ComponentPreview component="collapsible">
  ```tsx file=<rootDir>/src/examples/ui/collapsible/index.tsx
  ```
</ComponentPreview>
...
<ComponentPreview component="collapsible" example="default">
  ```tsx file=<rootDir>/src/examples/ui/collapsible/index.tsx
  ```
</ComponentPreview>
...
A basic collapsible inside a [Card](/docs/card). The trigger is rendered as a `Button` and the chevron rotates using the `data-panel-open` attribute.

<ComponentPreview component="collapsible" example="basic">
  ```tsx file=<rootDir>/src/examples/ui/collapsible/basic.tsx
  ```
</ComponentPreview>
...
<ComponentPreview component="collapsible" example="settings-panel">
  ```tsx file=<rootDir>/src/examples/ui/collapsible/settings-panel.tsx
  ```
</ComponentPreview>
